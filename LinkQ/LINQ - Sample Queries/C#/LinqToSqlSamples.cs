...
namespace SampleQueries {
    ...
    public class LinqToSqlSamples : SampleHarness {
        ...
        //private readonly static string sqlServerInstance = @"(localdb)\MSSQLLocalDB";
        ...
        private readonly static string connString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog = Northwind; Integrated Security = True; Connect Timeout = 30; Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
